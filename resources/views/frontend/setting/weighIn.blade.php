                    ...
                    <div class="col-xl-8">
                        <div class="tab-content">
                            ...
                            <div class="text-style">
                                <div class="tab-wei">
						 		<span>
						 			<label>Require weigh-in for</label>
						 			<div class="wei-con">
						 				<div class="full">
						 					<div class="cmp-arr">
                                    ...
                                    <span>
						 			...
						 			<div class="wei-con">
						 				<input type="number" name="attempts" class="editable-inline" placeholder="2">
						 			</div>
						 		</span>
                                    <span>
						 			<label>Tolerance</label>
						 			<div class="wei-con">
						 				<input type="number" name="attempts" class="editable-inline" placeholder="0">Grams
						 				<p>How much a competitor can be above their weight class without failing their weigh-in.</p>
						 			</div>
						 		</span>
                                    <span>
						 			<label>Enforce minimum weights</label>
						 			<div class="wei-con">
						 				<div class="cmp-arr">
							 				<select>
							 					<option>Yes</option>
